...
func main() {
	...
	drvPtr := flag.String("driver", "rppal", "drive GPIO via: <gpiocdev|rppal>")
	...
	switch *drvPtr {
	case "gpiocdev":
		fmt.Println("[+] Using driver: gpiocdev")
		drv := &JtagPinDriverGpioCDev{}
		jtag.setJtagDriver(drv)

	case "rppal":
		fmt.Println("[+] Using driver: rppal")
		drv := &JtagPinDriverRppal{}
		jtag.setJtagDriver(drv)
